...
<video autoPlay muted loop playsInline className="w-full rounded-xl" poster="/images/simulator/objects-pick-and-drop-poster.jpg" src="/videos/simulator/objects-pick-and-drop.mp4">
  Placing a blue can and a crate from Scene setup, then asking the agent to put the can in the box.
</video>
