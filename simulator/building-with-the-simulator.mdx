...
<Steps>
  ...
  <Step title="Trigger it">
    ...
    ([manual triggering](/software/skills#run-a-skill-manually)) — the simulated
...
Listing the class is enough — the agent picks up the skill by import, so a
rename or a typo is caught by your editor rather than on the robot.
...
[Agents](/software/agents) for everything an agent
can define.
