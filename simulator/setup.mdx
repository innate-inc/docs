...
<Steps>
  ...
  <Step title="Open the web app">
    ...
    self-signed certificate. This is the robot's own web app — the same one
    a physical MARS serves.

    ![The web app running against the simulator](/images/simulator/web-app.jpg)
  </Step>
</Steps>
