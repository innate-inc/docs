  ...
  <Step title="Install/open the app">
    ...
    <div style={{ display: "flex", gap: "16px", alignItems: "center", flexWrap: "wrap", marginTop: "8px" }}>
      <a href="https://innate.bot/android_app" style={{ display: "inline-flex", alignItems: "center", gap: "8px" }}>
        <img src="/images/logos/stores/google-play.svg" alt="Google Play" width="18" height="18" />
        <span>Android</span>
      </a>
      <a href="https://testflight.apple.com/join/YeChe4A7" style={{ display: "inline-flex", alignItems: "center", gap: "8px" }}>
        <img src="/images/logos/stores/app-store.svg" alt="App Store" width="18" height="18" />
        <span>iOS</span>
      </a>
    </div>
  </Step>
