...
You can also create your own agent, see [Anatomy of an Agent](/main/software/agents/definitions)
...
[Policy-Defined Skills](/main/software/skills/policy-defined-skills)[Code-Defined Skills](/main/software/skills/code-defined-skills)[Body Control Interfaces](/main/software/skills/code-defined-skills/body-control-interfaces)[ROS2 Core](/main/software/ros2-core)
...
[PreviousHome](/main)[NextMARS Quick Development](/main/welcome/mars-quick-development)
