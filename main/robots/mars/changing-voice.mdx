...
1. SSH into your robot (see [Connecting via SSH](/main/robots/mars/connecting-via-ssh))
...
1. Add or modify the `CARTESIA_VOICE_ID` variable:
...
1. Save the file and restart the robot for changes to take effect.
...
[PreviousFAQ](/main/robots/mars/faq)[NextTroubleshooting](/main/robots/mars/troubleshooting)
