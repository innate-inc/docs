...
First, [SSH into your robot](/main/robots/mars/connecting-via-ssh).
...
[PreviousChanging the Voice](/main/robots/mars/changing-voice)[NextCritical Fix (MARS IDs 1-11)](/main/robots/mars/troubleshooting/critical-fix-before-jan-16)
