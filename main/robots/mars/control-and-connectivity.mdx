...
* [Android](https://innate.bot/android_app)
...
For examples, see [MARS Quick Start](/main/welcome/mars-quick-start).
...
* [Android APK](https://cdn.innate.bot/innate-app-latest.apk)
* [iOS (TestFlight)](https://testflight.apple.com/join/YeChe4A7)
...
1. **Bluetooth pairing:** The app uses BLE to discover the robot and set network settings.
2. **Wi-Fi configuration:** Select the Wi-Fi network the robot should join.
3. **Connection:** Once both are on the same network, the app connects over Wi-Fi.
