...
`ssh jetson1@my-robot.local`

`MARS_01`

`mars-01.local`

`ssh jetson1@mars-01.local`

`Test Bot`

`test-bot.local`

`ssh jetson1@test-bot.local`
...
<Accordion title="chevron-rightShow USB-C connection instructions">
...
[PreviousUpdating MARS](/main/robots/mars/updating-mars)[NextStereo Depth Calibration](/main/robots/mars/stereo-depth-calibration)
