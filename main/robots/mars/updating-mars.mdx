...
A new robot OS version may require you to update the [Innate Controller App](/main/robots/innate-controller-app) for full compatibility.

If your update includes stereo-depth changes, run [Stereo Depth Calibration](/main/robots/mars/stereo-depth-calibration) before normal navigation.

***

## Prerequisites

* You can **SSH into your robot**. If WiFi isn't available, you can also [connect via the Jetson USB-C port](/main/robots/mars/connecting-via-ssh#via-usb-c-jetson).
...
[PreviousNavigation](/main/robots/mars/navigation)[NextConnecting via SSH](/main/robots/mars/connecting-via-ssh)
