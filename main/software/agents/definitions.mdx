...
Path to a 32×32 pixel icon

`get_inputs()`

`List[str]`

Input devices to activate (e.g., `["micro"]`)

`uses_gaze()`

`bool`

Enable person-tracking eye movement
...
[PreviousAgents](/main/software/agents)[NextStarting an Agent](/main/software/agents/starting-an-agent)
