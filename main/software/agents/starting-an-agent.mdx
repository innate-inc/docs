...
![](/images/main/software/agents/starting-an-agent.png)
...
* [Skills](/main/software/skills) — Create custom actions for your agents

* [Inputs](/main/software/inputs) — Connect additional sensors

* [System Overview](/main/software/overview) — Understand the full architecture

[PreviousAnatomy of an Agent](/main/software/agents/definitions)[NextAgent Examples](/main/software/agents/agent-examples)
