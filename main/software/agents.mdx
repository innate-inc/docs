...
![](/images/main/software/agents-overview.png)
...
[PreviousManual Triggering](/main/software/skills/manual-triggering)[NextAnatomy of an Agent](/main/software/agents/definitions)
