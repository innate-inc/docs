...
2. [Advanced](/main/software/advanced)
...
Move arm to joint positions over specified time
...
* [Troubleshooting via tmux](/main/robots/mars/troubleshooting) — debug running nodes

* [Connecting via SSH](/main/robots/mars/connecting-via-ssh) — access the robot terminal
...
[PreviousAdvanced](/main/software/advanced)
