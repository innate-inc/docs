...
Verify a skill works before deploying

**Debugging**

Isolate skill behavior from agent logic

**Direct control**

Run a specific action without voice/chat

**Demos**

Trigger skills on demand during presentations

[PreviousPolicy-Defined Skills](/main/software/skills/policy-defined-skills)[NextAgents](/main/software/agents)
