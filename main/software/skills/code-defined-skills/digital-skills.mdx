...
Recipients (defaults to configured list)
...
Latest camera frame (base64 JPEG)
...
See [Robot State](/main/software/skills/code-defined-skills/robot-state) for more details on the RobotState system.
...
[PreviousPhysical Skill Examples](/main/software/skills/code-defined-skills/physical-skill-examples)[NextPolicy-Defined Skills](/main/software/skills/policy-defined-skills)
