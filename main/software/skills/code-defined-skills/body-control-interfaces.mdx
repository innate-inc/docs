...
Get current orientation as dict

`get_current_end_effector_pose()`

—

Get current pose (position + quaternion)

`solve_ik()`

`x, y, z, roll, pitch, yaw, timeout`
...
[PreviousNavigation Interfaces](/main/software/skills/code-defined-skills/navigation-interfaces)[NextRobot State](/main/software/skills/code-defined-skills/robot-state)
