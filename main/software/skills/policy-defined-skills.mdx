...
Neural network trained on demonstrations

Tasks requiring visual adaptation

**Replay**

Recorded action sequence

Repeatable, fixed motions
...
Task requires visual adaptation
...
Motion must be identical every time

Replay

Simple gesture (wave, point)
...
[PreviousDigital Skills](/main/software/skills/code-defined-skills/digital-skills)[NextManual Triggering](/main/software/skills/manual-triggering)
