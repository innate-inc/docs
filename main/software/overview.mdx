...
See more in [Agents](/main/software/agents)
...
See how to create skills in [Skills](/main/software/skills)
...
Understand more how BASIC runs in [BASIC](/main/software/basic)

#### ROS2 core

Our OS runs at the core on **ROS2** and can be augmented at that level by roboticists that understand it.

See [ROS2 Core](/main/software/ros2-core) for more information on nodes, topics, and services available.

[PreviousConnecting to a robot](/main/robots/innate-controller-app/connecting-to-a-robot)[NextDevelopment Setup](/main/software/development-setup)
