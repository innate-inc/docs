...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="rocket" href="/welcome/mars-quick-start">
    Get your robot up and running. Connect your MARS, control it with the app,
    and run your first pre-built agent.
  </Card>
  <Card title="Developer Setup (10 min)" icon="wrench" href="/welcome/developer-setup-10-min">
    Connect your IDE over SSH and start editing code on MARS in minutes.
  </Card>
  <Card title="See Examples" icon="camera" href="/welcome/mars-example-use-cases">
...
[Troubleshooting](/robots/mars/troubleshooting)
