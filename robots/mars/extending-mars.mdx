...
By simply plugging a microphone in the robot and following the [Example: Microphone](/software/inputs/example-microphone) guide, you can now talk directly with your MARS, including when it's moving around and doing tasks.
...
[PreviousControl via app & leader arm](/robots/mars/control-via-app-and-leader-arm)[NextManipulation](/robots/mars/manipulation)
