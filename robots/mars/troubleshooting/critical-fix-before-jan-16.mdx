...
**This guide is only for** [**MARS IDs**](/robots/mars/faq#how-do-i-find-my-mars-id) **1-11** (received before January 16, 2026). If your [MARS ID](/robots/mars/faq#how-do-i-find-my-mars-id) is 12 or higher, this fix has already been applied and you can skip this page.
...
[PreviousTroubleshooting](/robots/mars/troubleshooting)[NextInnate Controller App](/robots/innate-controller-app)
