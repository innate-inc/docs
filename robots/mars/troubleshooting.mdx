...
## Early units (MARS IDs 1-11)

If you have one of the first eleven MARS units, it needed a [one-time setup fix](/robots/mars/troubleshooting/critical-fix-before-jan-16) before first use. Every robot from MARS ID 12 onwards shipped with this fix already applied, so chances are you can ignore this entirely.
