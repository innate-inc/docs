...
1. SSH into your robot (see [Connecting via SSH](/robots/mars/connecting-via-ssh))
...
[PreviousFAQ](/robots/mars/faq)[NextTroubleshooting](/robots/mars/troubleshooting)
