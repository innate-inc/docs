...
- **Teleoperation** — live video, driving (with [speed modes](/robots/mars/control-and-connectivity#drive-speed-modes)), the arm, head, speech, and [triggering skills](/software/skills/manual-triggering). → [Control & connectivity](/robots/mars/control-and-connectivity)
