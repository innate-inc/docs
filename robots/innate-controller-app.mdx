...
The latest version of the app is available  [here for android](https://github.com/innate-inc/robohacks-utils/releases/tag/android-app-rc1) and  [here for ios](https://testflight.apple.com/join/YeChe4A7).
