...
* **Robot Control** — Drive the robot and control the arm using your phone, with [Slow/Med/Fast/Mad speed modes](/robots/mars/control-and-connectivity#drive-speed-modes) and smoothed joystick drive
