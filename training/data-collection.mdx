...
In the app, open **Skills**, go to the *Datasets* tab, and open the skill you want to collect data for.  

Inside that skill page (Record tab), you will see an episodes counter (`N episodes`), the current episode list, and a **Record Episode** button.

## Record a new episode

<Steps>
  <Step title="Open record screen">
    At the bottom of the skill&apos;s page (Record tab), tap **Record Episode**.
  </Step>
...
After saving, return to the skill&apos;s **Datasets** tab to inspect your episodes.  
