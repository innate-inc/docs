...
<Steps>
  ...
  <Step title="Move your service key">
    The cloud service key lives in the original repo. Copy it over:

    ```bash
    cp ~/innate-os-backup/ros2_ws/src/cloud/clients/auth-client/auth_client/service_key.json \
       ~/innate-os/ros2_ws/src/cloud/clients/auth-client/auth_client/service_key.json
    ```
  </Step>
...
<Warning>
Keep your `service_key.json` private. Do not commit it to a public fork.
</Warning>
