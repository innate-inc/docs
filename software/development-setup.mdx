...
4. **Enter the SSH connection string** using the credentials and IP from the [Connecting via SSH](/robots/mars/connecting-via-ssh) page
...
[PreviousOverview](/software/overview)[NextSkills](/software/skills)
