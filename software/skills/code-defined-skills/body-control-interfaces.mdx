...
[PreviousNavigation Interfaces](/software/skills/code-defined-skills/navigation-interfaces)[NextRobot State](/software/skills/code-defined-skills/robot-state)
