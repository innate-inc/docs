...
Innate robots run an agentic OS built on top of ROS2. It is powered by **the Innate agent** — a loop running on the robot itself that watches what the robot sees, reasons about what to do, and triggers skills to do it (more on it [below](#the-innate-agent)).
