...
Innate robots run an agentic OS built on top of ROS2. It is powered by the Innate agent, our cloud agent.
...
The Innate agent is the embodied AI agent that controls Mars. It can run agents and skills, and gives Mars the ability to reason, memorize, plan and make decisions as it runs.

Understand more how the Innate agent runs in [Innate Capabilities](/software/agent)
