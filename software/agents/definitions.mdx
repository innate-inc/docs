...
Save this as `my_agent.py` in `~/innate-os/workspace/custom_agents/`, restart the runtime with `innate service restart`, and the system will load it automatically.
