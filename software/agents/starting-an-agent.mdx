...
* [Skills](/software/skills) — Create custom actions for your agents

* [Inputs](/software/inputs) — Connect additional sensors

* [System Overview](/software/overview) — Understand the full architecture

[PreviousAnatomy of an Agent](/software/agents/definitions)[NextAgent Examples](/software/agents/agent-examples)
