export const NavigationInterfaceMethods = () => {
  const rows = [
    ...
    },
    {
      method: "drive()",
      params: [
        { name: "get_xyt", type: "callable" },
        { name: "dist", type: "float (meters)" },
      ],
  ...
  const rows = [
    {
      ...
      params: [
        ...
        { name: "tolerance_xy", type: "float | None = 0.05" },
        { name: "tolerance_z", type: "float | None = 0.10" },
      ],
    ...
    },
    {
      method: "move_by()",
      params: [
        { name: "dx", type: "float = 0" },
        { name: "dy", type: "float = 0" },
        { name: "dz", type: "float = 0" },
