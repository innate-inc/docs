...
- **Latest Android APK** — attached to the [repo releases](https://github.com/innate-inc/robohacks-utils/releases/download/android-app-rc1/android-app.apk). The iOS app is available on [TestFlight](https://testflight.apple.com/join/YeChe4A7). TELEOPERATION ONLY WORKS ON ANDROID.
